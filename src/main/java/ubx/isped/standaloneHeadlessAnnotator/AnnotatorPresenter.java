...
@Path("headlessAnnotator")
public class AnnotatorPresenter {
    
    /**
     * Using slf4j for normal logging
     */
    private static final Logger log = LoggerFactory.getLogger(AnnotatorPresenter.class);
    ...
    public RdfViewable serviceEntry(@Context final UriInfo uriInfo, 
        ...
        return new RdfViewable("SiocPost", node, AnnotatorPresenter.class);
    }
...
//                loggedRequest.addProperty(RDF.type, OntologyWEB.LoggedRequest);
//                loggedRequest.addPropertyValue(DC.date, new Date());
//                loggedRequest.addPropertyValue(OntologyWEB.userAgent, userAgent);
//                loggedRequest.addProperty(OntologyWEB.requestedEntity, iri);
//                return null;
//            }
//        });
//        
